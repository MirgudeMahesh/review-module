  ...
  const handleSubmit = async () => {
    if (metric === '') {
      ...
      const payload = {
        ...
        receiver_code: 'abc', // placeholder as you said
        ...
        goal_date: selectedDate + '-01', // convert "YYYY-MM" to "YYYY-MM-01"
        receiver_commit_date: '', // left blank as per instruction
        commitment: text
      };
      // try {
        const response = await fetch('https://review-module-backend-3.onrender.com/putData', {
          method: 'POST',
          headers: {
